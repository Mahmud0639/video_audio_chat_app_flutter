...
class FirebaseMessagingHandler {
  ...
  const AndroidNotificationChannel(
    'com.manuni.video_audio_chat_flutter.call', // id
    'chattyLiv_call', // title
  ...
  const AndroidNotificationChannel(
    'com.manuni.video_audio_chat_flutter.message', // id
    'chattyLiv_message', // title
  ...
  static Future<void> config() async {
    ...
    try {
      ...
      //this part is work when the app is terminated, it wake up immediately,
      //but in the case of android it does not work sometimes
      ...
      //this part is also the part of above
      ...
      //this part execute when the app is in the foreground..that means app screen is open
  ...
  //when make a call we send our info to server then the server send these info's to the
  //firebase then firebase send them in this RemoteMessage message object
  ...
  //this part is executed when the app is in the background and need to
  //wake up
